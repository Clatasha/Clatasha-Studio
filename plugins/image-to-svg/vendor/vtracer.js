// VTracer @visioncortex/vtracer 1.0.0-alpha.4; MIT licensed. See LICENSE-MIT.txt.
...
// Browser adaptation of the upstream wasm-bindgen loader. No Node dependencies.
let wasm;
let initializing;
export async function initialize(bytes) {
    ...
    if (!initializing) initializing = (async () => {
        if (!bytes) {
            ...
            if (!response.ok) throw new Error('The local vector engine could not be loaded.');
